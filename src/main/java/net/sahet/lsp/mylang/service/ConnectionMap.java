...
public class ConnectionMap {
	...
	public static final ConnectionMap INSTANCE = new ConnectionMap();
	...
	private ConnectionMap() {
		InputStream propertiesStream = ConnectionMap.class.getResourceAsStream("/" + ConnectionMap.class.getPackage().getName().replace(".", "/") + "/EclipseConSessions.properties");
		try {
